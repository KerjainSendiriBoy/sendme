package com.example.sendme.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into " + TABLE_USER + " values ('rasyid@gmail.com','rasyid','Rasyid Hidayatullah');");
    }
    ...
    public boolean Register(String username, String password, String name) throws java.sql.SQLException {
    ...
    public Cursor getData(int id) {
        ...
        Cursor res = db.rawQuery("select * from "+TABLE_BOOK+" where "+COL_ID_BOOK+" = " + id + "", null);
        return res;
    }
}