...
import com.example.sendme.adapter.HistoryAdapter;
import com.example.sendme.model.HistoryModel;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    String ID = "", Asal, Tujuan, Tgl, Dws, Ank, nama;
    String email;
    TextView tvNotFound;
    TextView Ntid, Ntdws, Ntank, Nttot, Ntasal, Nttujuan, Nttgl;
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            hasil.add(new HistoryModel(id_book, tanggal, riwayat, total, R.mipmap.profile));
        }
        ...
        listBook.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                final CharSequence[] dialogitem = {"Hapus Data", "Lihat Nota"};
                AlertDialog.Builder builder = new AlertDialog.Builder(HistoryActivity.this);
                builder.setTitle("Pilihan");
                builder.setItems(dialogitem, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int item) {
                        if (dialogitem[item] == "Hapus Data") {
